...
//        {
             double z; // the distance between center of the object is surface depth + object size
             double x; //pixel coordinate u,v -> camera coordinate x,y
             double y;
